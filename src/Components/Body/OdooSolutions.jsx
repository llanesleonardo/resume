...
export default function OdooSolutions() {
  return (
    <div>
      <div className="container text-white text-center mx-auto px-5 ms:px-20 py-20 rounded">
        <div className='pb-10'>
          <GlobeAmericasIcon className="mx-auto w-8 h-8 text-white" />
        </div>
        <h1 className="text-2xl md:text-4xl mb-3">Unlock the Power of Odoo & Odoo.sh for Your Business</h1>
        ...
        <div className='text-justify mt-20'>
          <ul>
            <li className='my-5 text-slate-800 bg-white rounded py-5 px-10'>
              <h2 className='text-2xl md:text-3xl mb-3 text-center md:text-left'>Odoo Standard Implementation Process</h2>
            ...
            <li className='my-5 text-slate-800 bg-white rounded py-5 px-10'>
              <h2 className='text-2xl md:text-3xl mb-3 text-center md:text-left'>Odoo.sh Deployment & DevOps</h2>
              <p className='text-xl md:text-2xl'>
            ...
            <li className='my-5 text-slate-800 bg-white rounded py-5 px-10'>
              <h2 className='text-2xl md:text-3xl  mb-3 text-center md:text-left' >Modular Apps & Custom Development</h2>
              <p className='text-xl md:text-2xl'>
            ...
            <li className='my-5 text-slate-800 bg-white rounded py-5 px-10'>
              <h2 className='text-2xl md:text-3xl mb-3 text-center md:text-left'>Training & Ongoing Support</h2>
              <p className='text-xl md:text-2xl'>
